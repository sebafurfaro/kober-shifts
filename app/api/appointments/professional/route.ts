...
export async function GET(req: Request) {
  ...
  const todayAppointments = await findAppointmentsByDateRange(todayStart, todayEnd, {
    professionalId,
  });
  ...
  const futureAppointments = await findAppointmentsByDateRange(tomorrowStart, futureDate, {
    professionalId,
  });
