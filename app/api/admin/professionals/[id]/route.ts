...
export async function PUT(
  ...
  try {
    ...
    const availabilityConfig = body.availabilityConfig && typeof body.availabilityConfig === "object" ? body.availabilityConfig : null;
    ...
    if (profile) {
      ...
      if (availabilityConfig !== undefined) (profileUpdateData as any).availabilityConfig = availabilityConfig;
