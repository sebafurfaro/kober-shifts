...
export function PanelLayoutShell({
  ...
  const adminItems = [
    ...
    },
    {
      ...
      href: "/panel/admin/specialties",
      icon: <CategoryIcon />,
      show: configSections?.showSpecialties ?? true,
    },
    {
      label: "Profesionales",
      href: "/panel/admin/professionals",
      icon: <BadgeIcon />,
      show: true,
    },
    {
      ...
      >
        ...
        <Box sx={{ overflow: "auto" }}>
          ...
          <List>
            ...
            {role === "ADMIN" && <NavItem href="/panel/admin" label="Admin" icon={<AdminPanelSettingsIcon />} />}
          </List>
          ...
          {role === "PROFESSIONAL" && (
            <>
              <Divider sx={{ borderColor: "rgba(255, 255, 255, 0.2)" }} />
              <List>
                <NavItem href="/panel/professional/patients" label="Pacientes" icon={<PersonIcon />} />
              </List>
            </>
          )}
        </Box>
