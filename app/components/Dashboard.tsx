            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10">
                <div className="max-w-5xl mx-auto w-full px-4 md:px-0">
                    <div className="flex flex-col items-start justify-center space-y-6 px-4 lg:px-10 mb-12">
                        <div className="border border-accent p-1 w-60 rounded-full flex items-center justify-between mb-4 mx-auto lg:mr-auto">
                        ...
                        <Typography variant="h2" className="text-3xl lg:text-4xl font-bold text-center text-white">
                            Tu agenda <span className="text-accent">donde la necesites</span>
                        </Typography>
                        <Typography variant="p" color="white" className="font-medium!">
                            NODO App Turnos es la solución perfecta para gestionar tu agenda de manera inteligente y eficiente.
                        </Typography>
                        <Typography variant="p" color="white" className="font-medium!">Con una interfaz intuitiva y una amplia gama de funcionalidades, puedes organizar tu tiempo, gestionar tus turnos y maximizar tus ingresos sin complicaciones.</Typography>
                    </div>
                </div>
                <div>
                    <img src="/dashboard.png" alt="Dashboard" className="px-4 md:px-0 max-w-5xl mx-auto w-full h-auto" />
                    <img src="/login.png" alt="mobile" className="absolute bottom-0 max-w-[100px] lg:max-w-[250px] w-full shadow-2xl" />
                </div>
            </div>
